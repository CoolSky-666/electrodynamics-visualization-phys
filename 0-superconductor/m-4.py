...
# 计算公式中的各个部分
term1 = -H0 * X
term2 = -(H0 * a**3 * X) / (2*np.power(X**2 + Y**2, 1.5))
...
# 添加磁偶极子矢量箭头
plt.quiver(0, 0, 2, 0, angles='xy', scale_units='xy',color='darkorange', scale=1,zorder=3,pivot ='middle')
plt.text(0, -0.75, f'm\'', color='darkorange', ha='center',zorder=6)
